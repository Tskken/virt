    ...
    let vertex_buffer = {
        ...
        CpuAccessibleBuffer::from_iter(
            ...
            [
                ...
                Vertex {
                    position: [50f32,150f32],
                },
                Vertex {
                    position: [150f32,150f32],
                },
                Vertex {
                    position: [50f32,50f32],
                },
                Vertex {
                    position: [150f32,50f32],
                },
                Vertex {
                    position: [150f32,150f32],
                },
    ...
    mod vs {
        vulkano_shaders::shader! {
            ...
            src: "
                ...
                layout(location = 0) out vec2 v_resolution;
                
                void main() {
                    v_resolution = pc.bounds;
    ...
    mod fs {
        vulkano_shaders::shader! {
            ...
            src: "
                ...
                layout(location = 0) in vec2 v_resolution;
